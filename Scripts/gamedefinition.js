...
var game =
{
    ...
    screws:
    {
        ...
        getScrews: level => new Decimal(2 + Math.floor(Math.min(Math.max(23, getScrews()), (level / 100)))).mul(applyUpgrade(game.barrelMastery.upgrades.screwBoost).pow(getTotalLevels(9))),
    ...
    skillTree:
    {
        ...
        upgrades:
        {
            ...
            higherNeptuneMax: new SkillTreeUpgrade(
                level => new Decimal("1e80000").pow(level + 1), RESOURCE_BRICK,
            ...
            newTireUpgrades: new SkillTreeUpgradeFixed([
                [[new Decimal(2000), RESOURCE_REINFORCEDBEAM], [new Decimal(10), RESOURCE_FISHINGNET], [new Decimal("1e100000"), RESOURCE_TIRE]],
            ], [false, true], {
                getEffectDisplay: effectDisplayTemplates.unlock()
            }, ["unlockScrews"]),

            posusAffectsDark: new SkillTreeUpgradeFixed([
                [[new Decimal(20000), RESOURCE_SCREW], [new Decimal(1e20), RESOURCE_DARKFRAGMENT], [new Decimal(1000), RESOURCE_BEAM]],
            ], [false, 0.5], {
                getEffectDisplay: effectDisplayTemplates.unlockEffect("^")
            }, ["unlockScrews"]),
    ...
    autos:
    {
        autoBetterBarrels: new AutoUpgrade(
            level => new Decimal(Math.round(level / 60) + 1),
        ...
        autoBrickUpgrades: new AutoUpgrade(
            level => new Decimal(level == 0 ? 16 : 3),
    ...
    collectors: {
        ...
        aerobeams: new AutoUpgrade(
            level => new Decimal(4 + Math.floor(level / 11)),
            level => level * (game.supernova.cosmicUpgrades.strongerCollectors.level + 1),
        ...
        angelbeams: new AutoUpgrade(
            level => new Decimal(1 + Math.floor(level / 10)),
            level => level * (game.supernova.cosmicUpgrades.strongerCollectors.level + 1),
        ...
        glitchbeams: new AutoUpgrade(
            level => new Decimal(3 + Math.floor(level / 6)),
            level => level * (game.supernova.cosmicUpgrades.strongerCollectors.level + 1),
        ...
        tires: new AutoUpgrade(
            level => new Decimal(4 + Math.floor(level / 8)),
            level => level,
    ...
    milestones:
    {
         ...
         * 66c6ff barrels
         * #9b8585 second dim
         * #6bff60 gotta get out of your way
         * #ec91ff secret achievements
         */
        achievements:
            [
                ...
                new Milestone(4, "Time to Retire!", 4, () => "Reach " + formatNumber(1e15) + " Scrap to be able to\nReset to get Golden Scrap.\nEach Golden Scrap Boosts Scrap\nProduction by 1%.", () => game.highestScrapReached.gte(1e15),
                    ["<amount>", "formatNumber(1e15)"], "#ffff00"),
                new Milestone(276, "Adventure von Tonne I", 122, () => "Reach Barrel 10", () => game.highestBarrelReached >= 10 - 1,
                    [], "#66c6ff"),
                ...
                new Milestone(7, "More Upgrades!", 58, "Buy your first\nGolden Scrap Upgrade", () => Utils.filterObject(game.goldenScrap.upgrades, upg => upg.level > 0).length > 0,
                    [], "#b7b772"),
                new Milestone(9, "Septillionaire", 7, () => "Reach " + formatNumber(1e24) + " Scrap", () => game.highestScrapReached.gte(1e24),
                    ["<amount>", "formatNumber(1e24)"]),
                new Milestone(277, "Adventure von Tonne II", 122, () => "Reach Barrel 20", () => game.highestBarrelReached >= 20 - 1,
                    [], "#66c6ff"),

                new Milestone(8, "Automation", 6, "Reach <amount> Golden Scrap to\nunlock auto-merging", () => game.goldenScrap.amount.gte(1000),
                    ["<amount>", "formatThousands(1000)"], "#ffff00"),
                new Milestone(10, "Double Magnet", 59, "Get 2 Magnets each time you Merge", () => getMagnetBaseValue().gte(2)),
                new Milestone(278, "Adventure von Tonne III", 122, () => "Reach Barrel 30", () => game.highestBarrelReached >= 30 - 1,
                    [], "#66c6ff"),
                new Milestone(11, "Apollo 21", 49, "Reach Level 8 on the \"More Scrap\"\nGolden Scrap Upgrade to\nexplore the Solar System!", () => game.goldenScrap.upgrades.scrapBoost.level >= 8,
                    [], "#ffff00"),
                new Milestone(12, "Magnetism", 2, () => "Have <amount> Magnets at once", () => game.magnets.gte(1000),
                    ["<amount>", "formatThousands(1000)"]),
                ...
                new Milestone(15, "AM go brrrrrr", 28, "Barrels spawn faster than 500ms", () => applyUpgrade(game.scrapUpgrades.fasterBarrels).toNumber() < 0.5,
                    [], "#66c6ff"),
                ...
                new Milestone(19, "Magnets & Mayonnaise", 2, () => "Have <amount> Magnets at once", () => game.magnets.gte(10000),
                    ["<amount>", "formatNumber(10000)"]),
                new Milestone(279, "Adventure von Tonne IV", 122, () => "Reach Barrel 60", () => game.highestBarrelReached >= 60 - 1,
                    [], "#66c6ff"),
                ...
                new Milestone(26, "Who needs Upgrades", 13, () => "Get " + formatNumber(1e15) + " Scrap without\nbuying Scrap Upgrades", () => game.scrap.gte(1e15) && game.scrapUpgrades.betterBarrels.level === 0 && game.scrapUpgrades.fasterBarrels.level === 0,
                    ["<amount>", "formatNumber(1e15)"], "#6bff60"),
                new Milestone(27, "M.P. + W2ed", 8, "Have 69,420 magnets at once", () => game.magnets.gte(69420)),
                new Milestone(28, "RPG", 14, () => "Reach " + formatNumber(1e93) + " Scrap to\nunlock Merge Quests!", () => game.highestScrapReached.gte(1e93),
                    ["<amount>", "formatNumber(1e93)"], "#ffff00"),
                new Milestone(29, "Best Barrels", 10, "Reach Better Barrels Upgrade Level 200", () => game.scrapUpgrades.betterBarrels.level >= 200,
                    [], "#66c6ff"),

                new Milestone(30, "Apollo 23", 15, "Unlock Mars by upgrading Earth!", () => game.solarSystem.upgrades.earth.level >= EarthLevels.UNLOCK_MARS,
                    [], "#ffff00"),
                new Milestone(31, "Reinforcements", 16, () => "Reach " + formatNumber(1e153) + " Scrap to\nunlock Merge Mastery!", () => game.highestScrapReached.gte(1e153),
                    ["<amount>", "formatNumber(1e153)"], "#ffff00"),
                new Milestone(32, "Speed of Sound", 28, "Barrels spawn faster than 250ms", () => applyUpgrade(game.scrapUpgrades.fasterBarrels).toNumber() < 0.25,
                    [], "#66c6ff"),
                ...
                new Milestone(35, "Interesting Barrels", 10, "Reach Better Barrels Level 300,\nwhere the Barrels get interesting", () => game.scrapUpgrades.betterBarrels.level >= 300,
                    [], "#66c6ff"),
                ...
                new Milestone(107, "The worst currency", 66, "Unlock wrenches (12k manual merges)", () => game.wrenches.isUnlocked(),
                    [], "#ffff00"),
                new Milestone(281, "Adventure von Tonne VI", 122, () => "Reach Barrel 400", () => game.highestBarrelReached >= 400 - 1,
                    [], "#66c6ff"),

                new Milestone(36, "Who needs Upgrades II", 13, () => "Get <amount> Scrap without\nbuying Scrap Upgrades", () => game.scrap.gte(1e30) && game.scrapUpgrades.betterBarrels.level === 0 && game.scrapUpgrades.fasterBarrels.level === 0,
                    ["<amount>", "formatNumber(1e30)"], "#6bff60"),
                new Milestone(37, "Magnetism II", 2, () => "Have <amount> Magnets at once", () => game.magnets.gte(10e6),
                    ["<amount>", "formatThousands(10e6)"]),
                new Milestone(108, "Better than the dev", 66, "Have more than 5292 wrenches at once", () => game.wrenches.amount > 5292),
                new Milestone(38, "Building Blocks", 18, () => "Reach " + formatNumber(1e213) + " Scrap to\nunlock Bricks!", () => game.highestScrapReached.gte(1e213),
                    ["<amount>", "formatNumber(1e213)"], "#ffff00"),
                new Milestone(39, "Overproductive Start", 21, () => "First Barrel produces more than " + formatNumber(1e63) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(1e63) && game.dimension == 0,
                    ["<amount>", "formatNumber(1e63)"]),
                ...
                new Milestone(40, "HUGE Scrap", 11, () => "Upgrade the Sun to Level 1000\n(Currently: " + game.solarSystem.upgrades.sun.level.toFixed(0) + ")", () => game.solarSystem.upgrades.sun.level >= 1000,
                    ["<value>", "game.solarSystem.upgrades.sun.level.toFixed(0)"]),
                ...
                new Milestone(41, "Who needs Upgrades III", 13, () => "Get " + formatNumber(1e90) + " Scrap without\nbuying Scrap Upgrades", () => game.scrap.gte(1e90) && game.scrapUpgrades.betterBarrels.level === 0 && game.scrapUpgrades.fasterBarrels.level === 0,
                    ["<amount>", "formatNumber(1e90)"], "#6bff60"),
                new Milestone(42, "Infinity", 19, () => "Reach " + formatNumber(Decimal.pow(2, 1024)) + " Scrap", () => game.highestScrapReached.gte(Decimal.pow(2, 1024)),
                    ["<amount>", "formatNumber(Decimal.pow(2, 1024))"], "red"),
                new Milestone(43, "100%", 20, "Upgrade Mercury to Level 99", () => game.solarSystem.upgrades.mercury.level >= 99),

                new Milestone(44, "Millions at once", 22, () => "Get <amount> Magnets per Merge", () => getMagnetBaseValue().gte(1e6),
                    ["<amount>", "formatThousands(1e6)"]),
                ...
                new Milestone(93, "I steal beans", 52, () => "Hoard quite some Steel Beams", () => game.beams.amount > 99,
                    [], "#6bff60"),
                new Milestone(46, "Tire", 26, "Get your first Tire\nReach Barrel 500 to unlock Tires", () => game.tires.amount.gt(0),
                    [], "#ffff00"),
                new Milestone(47, "It is possible", 24, () => "Reach " + formatNumber(new Decimal("1e500")) + " Bricks", () => game.bricks.amount.gte(new Decimal("1e500")),
                    ["<amount>", "formatNumber(new Decimal('1e500'))"]),

                new Milestone(95, "Worth a LOT", 54, () => "Increase the Beam worth to 5", () => game.beams.upgrades.beamValue.level > 3),
                new Milestone(119, "Ski", 72, () => "Ski", () => game.highestBarrelReached >= 552,
                    [], "#ec91ff"),
                new Milestone(48, "COLOSSAL Scrap", 11, () => "Upgrade the Sun to Level 5000\n(Currently: " + game.solarSystem.upgrades.sun.level.toFixed(0) + ")", () => game.solarSystem.upgrades.sun.level >= 5000,
                    ["<amount>", "game.solarSystem.upgrades.sun.level.toFixed(0)"]),
                new Milestone(94, "Bee-ms", 53, () => "Increase the Beam frequency a bit", () => game.beams.upgrades.fasterBeams.level > 3),
                new Milestone(49, "RPG v2", 32, "Unlock the Skill Tree by upgrading Earth", () => game.skillTree.isUnlocked(),
                    [], "#ffff00"),

                new Milestone(50, "Apollo 99", 31, "Unlock the whole Solar System", () => game.solarSystem.upgrades.earth.level >= EarthLevels.UNLOCK_NEPTUNE,
                    [], "#ffff00"),
                new Milestone(51, "Ultra Mastery", 16, "Reach Merge Mastery Level 300", () => game.highestMasteryLevel >= 300,
                    [], "#e0e0e0"),
                new Milestone(52, "The Secret Upgrade", 34, "Unlock a new Merge Quest Upgrade...", () => game.skillTree.upgrades.mergeQuestUpgFallingMagnet.isUnlocked(),
                    [], "#ffff00"),
                new Milestone(282, "Adventure von Tonne VII", 122, () => "Reach Barrel 750", () => game.highestBarrelReached >= 750 - 1,
                    [], "#66c6ff"),
                ...
                new Milestone(53, "Evolution of Tires", 27, "Unlock all Tire Upgrades", () => game.tires.amount.gte(game.tires.milestones[2]),
                    [], "#ffff00"),
                new Milestone(54, "Speed of Light", 28, "Auto Merger is faster than 0.25s", () => applyUpgrade(game.solarSystem.upgrades.saturn).lte(0.25),
                    [], "#00d7ff"),
                ...
                new Milestone(57, "It is indeed\npossible", 25, () => "\n\nReach " + formatNumber(new Decimal("1e5000")) + " Tires", () => game.tires.amount.gte(new Decimal("1e5000")),
                    ["<amount>", "formatNumber(new Decimal('1e5000'))"]),
                new Milestone(96, "500m³ of beams", 55, () => "Increase the storm value to the max.", () => game.beams.upgrades.beamStormValue.level == 5),
                new Milestone(58, "Is this even\npossible??", 23, () => "\n\nHave " + formatThousands(1e15) + " Magnets at once", () => game.magnets.gte(1e15),
                    ["<amount>", "formatThousands(1e15)"]),
                ...
                new Milestone(283, "Adventure von Tonne VIII", 122, () => "Reach the final Barrel", () => game.highestBarrelReached >= 1000 - 1,
                    [], "#66c6ff"),

                new Milestone(284, "Veteran Barrels I", 123, () => "Get 1 Star Barrels", () => game.highestBarrelReached >= 1000,
                    [], "#66c6ff"),
                new Milestone(59, "Best Barrels III", 10, "Reach Better Barrels Upgrade Level 1000", () => game.scrapUpgrades.betterBarrels.level >= 1000,
                [], "#66c6ff"),
                new Milestone(60, "Warp 9.9", 28, "Barrels spawn faster than 5ms", () => applyUpgrade(game.scrapUpgrades.fasterBarrels).toNumber() < 0.005,
                    [], "#66c6ff"),
                ...
                new Milestone(64, "TABLE SMASH!!!", 25, () => "Reach " + formatNumber(new Decimal("1e10000")) + " Tires", () => game.tires.amount.gte(new Decimal("1e10000")),
                    ["<amount>", "formatNumber(new Decimal('1e10000'))"]),
                new Milestone(65, "Best Barrels V", 10, "Reach Better Barrels Upgrade Level 3000", () => game.scrapUpgrades.betterBarrels.level >= 3000,
                    [], "#66c6ff"),

                new Milestone(66, "Need more\nInfinities", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(2, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(Decimal.pow(2, 1024)) && game.dimension == 0,
                    ["<amount>", "formatNumber(Decimal.pow(2, 1024))"]),
                ...
                new Milestone(74, "Dark money???", 40, () => "Earn some Dark Scrap", () => game.darkscrap.amount > 24,
                    [], "#9b8585"),
                new Milestone(75, "Fragments from the\nother side", 41, () => "\n\nEarn your first dark fragments\n(by converting in the Second Dimension)", () => game.darkfragment.amount > 1,
                    [], "#ffff00"),
                new Milestone(122, "Champion", 0, () => "100 Achievements", () => game.ms.length > 99,
                    [], "#6bff60"),

                new Milestone(114, "Magnet Storms?", 23, () => "Unlock a new storm type (through Aerobeams)", () => game.aerobeams.upgrades.unlockGoldenScrapStorms.level > 0,
                    [], "#ffff00"),
                new Milestone(67, "Need more\nInfinities II", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(4, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(Decimal.pow(4, 1024)) && game.dimension == 0,
                    ["<amount>", "formatNumber(Decimal.pow(4, 1024))"]),
                ...
                new Milestone(80, "Double Tap Double Pain", 41, () => "Earn 100k Dark Fragments", () => game.darkfragment.amount > 99999,
                    [], "#9b8585"),
                new Milestone(285, "Veteran Barrels II", 123, () => "Get 5 Star Barrels", () => game.highestBarrelReached >= 5000,
                    [], "#66c6ff"),
                new Milestone(109, "But it doesn't cost scrap!", 67, "Unlock the Scrapyard\n(Skill Tree)", () => game.skillTree.upgrades.unlockScrapyard.level > 0,
                    [], "#ffff00"),

                new Milestone(116, "No storm :(", 22, () => "Increase storm chance to max.", () => game.angelbeams.upgrades.goldenScrapStormChance.level > 37),
                new Milestone(68, "Need more\nInfinities III", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(8, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(Decimal.pow(8, 1024)) && game.dimension == 0,
                    ["<amount>", "formatNumber(Decimal.pow(8, 1024))"]),
                ...
                [], "#ffff00"),
                new Milestone(82, "I've seen them all", 51, () => "Reach Better Barrels 1000 in the Second Dimension", () => game.dimension == 1 && game.scrapUpgrades.betterBarrels.level >= 1000,
                    [], "#9b8585"),
                ...
                new Milestone(69, "Are we there yet?", 29, () => "Reach " + formatNumber(Decimal.pow(9.999, 1000)) + " Scrap", () => game.highestScrapReached.gte(Decimal.pow(9.999, 1000)),
                    ["<amount>", "formatNumber(Decimal.pow(9.999, 1000))"], "red"),

                new Milestone(113, "I like to call it cloning", 27, () => "Spawn a tire by collecting a tire!", () => false,
                    [], "#ec91ff"),
                new Milestone(118, "Sponsored by Angel Beams", 4, () => "Reach " + formatNumber(new Decimal(1e60)) + " Golden Scrap", () => game.goldenScrap.amount.gte(1e60),
                    ["<amount>", "formatNumber(new Decimal(1e60))"]),
                new Milestone(70, "Inf.^10", 36, () => "Reach " + formatNumber(Decimal.pow(2, 10240)) + " Scrap", () => game.highestScrapReached.gte(Decimal.pow(2, 10240)),
                    ["<amount>", "formatNumber(Decimal.pow(2, 10240))"], "#b60045"),
                ...
                new Milestone(134, "Almost legendary scrap", 4, () => "Reach " + formatNumber(new Decimal(1e80)) + " Golden Scrap", () => game.goldenScrap.amount.gte(1e80),
                    ["<amount>", "formatNumber(new Decimal(1e80))"]),
                ...
                new Milestone(139, "What the...?", 83, "Unlock the Factory area", () => game.solarSystem.upgrades.earth.level >= EarthLevels.SCRAP_FACTORY,
                    [], "#ffff00"),
                ...
                new Milestone(202, "Champion II", 0, () => "150 Achievements", () => game.ms.length > 149,
                    [], "#6bff60"),
                new Milestone(143, "Fail... Repeat!", 89, "Repeat a Beam", () => false,
                    [], "#ec91ff"),
                ...
                new Milestone(156, "RPG v3 (Mastery 2.0)", 92, "Unlock Barrel Mastery", () => game.barrelMastery.isUnlocked(),
                    [], "#ffff00"),
                new Milestone(157, "Influenced by the barrels", 1, "Unlock the first mastery upgrade\n(Get 10 Barrels to M1)", () => getTotalLevels(1) > 9,
                    [], "#ffff00"),
                ...
                new Milestone(159, "Uhh, why aren't\nyou using them?", 93, "\n\nRefuse to spend your Mastery Tokens\nfor a while", () => game.barrelMastery.masteryTokens.gte(new Decimal(500)),
                    [], "#6bff60"),
                new Milestone(231, "Lots of Love", 116, "Send a gift to someone", () => false),
                ...
                new Milestone(162, "Million Merge Champion", 0, "Have 1M mastery merges on barrel 204", () => game.barrelMastery.b[203] >= 1000000),
                new Milestone(232, "Is for me?", 116, "Receive a gift from someone", () => false),
                ...
                new Milestone(117, "For the Door Handle\nSalesman", 19, "\n\nReach " + Decimal.pow(2, 15360).toFixed(2) + " Scrap", () => game.highestScrapReached.gte(Decimal.pow(2, 15360)),
                    ["<amount>", "Decimal.pow(2, 15360).toFixed(2)"]),
                ...
                new Milestone(233, "Laughing Out Loud", 116, "Leave a special message for someone...", () => false,
                    [], "#6bff60"),
                ...
                new Milestone(176, "Scrap Collector", 97, "Unlock Auto Collectors (Skill Tree)", () => game.skillTree.upgrades.unlockAutoCollectors.level > 0,
                    [], "#ffff00"),
                ...
                new Milestone(180, "In the long run", 40, () => "Earn " + formatNumber(1e30) + " Dark Scrap", () => game.darkscrap.amount.gte(1e30),
                    ["<amount>", "formatNumber(1e30)"]),

                new Milestone(286, "Veteran Barrels III", 123, () => "Get 10 Star Barrels", () => game.highestBarrelReached >= 10000,
                    [], "#66c6ff"),
                ...
                new Milestone(120, "Can't touch this", 69, () => "Reach " + formatNumber(new Decimal(2).pow(20480)) + " Scrap\nStop... scrap grinding time!", () => game.highestScrapReached.gte(Decimal.pow(2, 20480)),
                    ["<amount>", "formatNumber(new Decimal(2).pow(20480))"]),
                ...
                new Milestone(204, "Everyone can read it", 38, () => "Switch to the ultimate notation\nwhile having at least " + formatNumber(new Decimal(1e182)) + " magnets", () => game.settings.numberFormatType == 12 && game.magnets.gte(new Decimal(1e182)),
                    ["<amount>", "formatNumber(new Decimal(1e182))"]),
                ...
                new Milestone(206, "Power Beams", 77, () => "140 Beams per minute", () => false),
                new Milestone(207, "Schrottii", 109, () => "Click Schrottii\nto see her other games", () => false,
                    [], "#ec91ff"),

                new Milestone(208, "Slower can be better", 87, () => "Make an autobuyer slower", () => false),
                ...
                new Milestone(212, "Tim Mode", 112, "Unlock Time Mode", () => game.skillTree.upgrades.unlockTimeMode.level > 0,
                    [], "#ffff00"),
                new Milestone(213, "Third Dimension", 112, () => "Start a run...", () => false),
                ...
                new Milestone(236, "Infinite GS", 4, () => "Reach " + formatNumber(new Decimal("2e308")) + " Golden Scrap", () => game.goldenScrap.amount.gte("2e308"),
                    ["<amount>", "formatNumber(new Decimal('2e308'))"]),
                new Milestone(234, "Advent Calendar", 116, "Send 25 Gifts to the people", () => game.stats.giftsSent.gte(24)),
                ...
                new Milestone(216, "...wheels", 113, () => "Earn 1000 cogwheels in a single run", () => false,
                    [], "#6bff60"),
                ...
                new Milestone(254, "Unfair", 117, "Attempt to send a gift to yourself", () => false,
                    [], "#6bff60"),
                ...
                new Milestone(165, "Nobody can touch this", 69, () => "Reach " + formatNumber(new Decimal(2).pow(40960)) + " Scrap\nStop... scrap grinding time!", () => game.highestScrapReached.gte(Decimal.pow(2, 40960)),
                    ["<amount>", "formatNumber(new Decimal(2).pow(40960))"]),
                new Milestone(237, "500 Golden", 4, () => "Reach " + formatNumber(new Decimal("1e500")) + " Golden Scrap", () => game.goldenScrap.amount.gte("1e500"),
                    ["<amount>", "formatNumber(new Decimal('1e500'))"]),
                new Milestone(238, "The Final Unlock", 121, "Max. Earth", () => game.solarSystem.upgrades.earth.level >= EarthLevels.UNLOCK_NOVA),
                new Milestone(239, "The Final Tree Upgrade", 32, "Buy the final tree upgrade", () => game.skillTree.upgrades.unlockSupernova.level > 0,
                    [], "#ffff00"),

                new Milestone(298, "Superseed", 32, "Buy every tree upgrade", () => Utils.filterObject(game.skillTree.upgrades, upg => upg.level > 0).length == Object.keys(game.skillTree.upgrades).length,
                    [], "#ffff00"),
                ...
                new Milestone(235, "They Call Me Santa", 117, "Send 60 Gifts to the people", () => game.stats.giftsSent.gte(60),
                    [], "#6bff60"),
                new Milestone(147, "Time to go AFK...", 87, "Max. the first auto buyer", () => game.autos.autoBetterBarrels.level > 116),
                new Milestone(229, "Need more Nice", 30, () => "First Barrel produces more than " + formatNumber(new Decimal("6e9420")) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(new Decimal("6e9420")) && game.dimension == 0,
                    ["<amount>", "formatNumber(new Decimal('6e9420'))"]),
                ...
                new Milestone(241, "I'm a star", 120, "Get your first star!", () => game.supernova.stars.gt(0)),
                new Milestone(256, "Hyper Boy", 103, "Set Hyper Buy to 69%", () => false),
                new Milestone(259, "Master's Second Page", 92, "Unlock the sixth mastery upgrade\n(After supernova)", () => getTotalLevels(6) > 19 && game.supernova.stars.gte(1),
                    [], "#ffff00"),
                new Milestone(296, "Questyard", 68, "Upgrade scrapyard to level 1001", () => game.mergeQuests.scrapyard > 1000),
                new Milestone(297, "The Final, again", 32, "Buy the final tree upgrade again", () => game.skillTree.upgrades.unlockSupernova.level > 0 && game.supernova.stars.gt(0),
                    [], "#ffff00"),

                new Milestone(290, "Twopernova", 120, "Get your second Star", () => game.supernova.stars.gte(2)),
                new Milestone(200, "Crab Saver VII", 96, "Buy 10000 Plastic Bags (in total)", () => game.stats.totalplasticbags.gte(10000)),
                new Milestone(291, "A Charm", 120, "Get your third Star", () => game.supernova.stars.gte(3)),
                new Milestone(260, "Merging Forever", 92, "Unlock the last mastery upgrade\n(After supernova)", () => getTotalLevels(10) > 19 && game.supernova.stars.gte(1),
                    [], "#ffff00"),
                new Milestone(299, "A-maz-max-ing", 32, "MAX every tree upgrade", () => Utils.filterObject(game.skillTree.upgrades, upg => upg.maxLevel != undefined ? upg.level == upg.maxLevel : upg.level > 0).length == Object.keys(game.skillTree.upgrades).length,
                    [], "#ffff00"),

                new Milestone(242, "Scrap 2 Moment", 120, "Get your tenth star!", () => game.supernova.stars.gte(10)),
                new Milestone(246, "Blessing from\nthe Aliens", 119, () => "\n\nHave " + formatNumber(100000) + " total Alien Dust", () => game.stats.totalaliendust.gte(100000),
                ["<amount>", "formatNumber(new Decimal('100000'))"]),
                ...
                ["<amount>", "formatNumber(new Decimal('100000'))"]),
                new Milestone(292, "2 Star 5 Me", 120, "Get your 25th Star", () => game.supernova.stars.gte(25)),
                ...
                new Milestone(155, "Tire Club", 88, () => "Reach " + formatNumber(new Decimal("1e1e9")) + " tires\nand unlock the Tire Club!", () => game.tires.amount.gte("1e1000000000"),
                    ["<amount>", "formatNumber(new Decimal('1e1e9'))"], "#ffff00"),
                new Milestone(249, "Yellow", 4, () => "Reach " + formatNumber(new Decimal("1e2500")) + " Golden Scrap", () => game.goldenScrap.amount.gte("1e2500"),
                    ["<amount>", "formatNumber(new Decimal('1e2500'))"]),
                new Milestone(289, "The final feature", 124, () => "Unlock Cosmic Pins", () => game.supernova.stars.gte(50),
                    [], "#ffff00"),
                new Milestone(248, "Not even aliens\ncan touch this", 69, () => "\n\nReach " + formatNumber(new Decimal(2).pow(327680)) + " Scrap\nStop... scrap grinding time!", () => game.highestScrapReached.gte(Decimal.pow(2, 327680)),
                    ["<amount>", "formatNumber(new Decimal(2).pow(327680))"]),

                new Milestone(243, "Scrapstar", 120, "Get your 100th star!", () => game.supernova.stars.gte(100)),
                new Milestone(252, "Apocalypse from\nthe Aliens", 119, () => "\n\nHave " + formatNumber(1e12) + " total Alien Dust", () => game.stats.totalaliendust.gte(1e12),
                    ["<amount>", "formatNumber(new Decimal('1e12'))"]),
                new Milestone(253, "Apocalypse from\nthe Fairies", 119, () => "\n\nHave " + formatNumber(1e12) + " total Fairy Dust", () => game.stats.totalfairydust.gte(1e12),
                    ["<amount>", "formatNumber(new Decimal('1e12'))"]),
                new Milestone(251, "Apocalypse from\nthe Stars", 119, () => "\n\nHave " + formatNumber(1e12) + " total Star Dust", () => game.stats.totalstardust.gte(1e12),
                    ["<amount>", "formatNumber(new Decimal('1e12'))"]),
                new Milestone(255, "I don't!", 118, "Have 42 Cosmic Emblems at the same time", () => game.supernova.cosmicEmblems.gt(41),
                    [], "#6bff60"),

                new Milestone(287, "Veteran Barrels IV", 123, () => "Get 100 Star Barrels", () => game.highestBarrelReached >= 100000,
                    [], "#66c6ff"),
                ...
                new Milestone(293, "Wales", 120, "Get your 200th Star", () => game.supernova.stars.gte(200)),
                new Milestone(270, "Second Tire Club", 88, () => "Reach " + formatNumber(new Decimal("1e1e25")) + " Tires\n(There is only one)", () => game.tires.amount.gte(new Decimal("1e1e25")),
                    ["<amount>", "formatNumber(new Decimal('1e1e25'))"]),

                new Milestone(265, "Infinity Scrap War", 1, () => "Reach " + formatNumber(new Decimal("1e1e10")) + " Scrap\n...why are you still playing?", () => game.highestScrapReached.gte(new Decimal("1e1e10")),
                    ["<amount>", "formatNumber(new Decimal('1e1e10'))"]),
                new Milestone(272, "Still building...", 18, () => "Reach " + formatNumber(new Decimal("1e1e7")) + " Bricks\nYou can do it!", () => game.bricks.amount.gte(new Decimal("1e1e7")),
                    ["<amount>", "formatNumber(new Decimal('1e1e7'))"]),
                new Milestone(267, "Magnitov", 2, () => "Reach " + formatNumber(new Decimal("1e1e10")) + " Magnets\n...why are you still playing?", () => game.magnets.gte(new Decimal("1e1e10")),
                    ["<amount>", "formatNumber(new Decimal('1e1e10'))"]),
                ...
                new Milestone(288, "Veteran Barrels V", 123, () => "Get 10000 Star Barrels", () => game.highestBarrelReached >= 10000000,
                    [], "#66c6ff"),
                new Milestone(263, "The Last Aliens", 119, () => "Have " + formatNumber(1e60) + " total Alien Dust", () => game.stats.totalaliendust.gte(1e60),
                    ["<amount>", "formatNumber(new Decimal('1e60'))"]),
                new Milestone(264, "The Last Fairies", 119, () => "Have " + formatNumber(1e60) + " total Fairy Dust", () => game.stats.totalfairydust.gte(1e60),
                    ["<amount>", "formatNumber(new Decimal('1e60'))"]),
                new Milestone(262, "The Last Stars", 119, () => "Have " + formatNumber(1e60) + " total Star Dust", () => game.stats.totalstardust.gte(1e60),
                    ["<amount>", "formatNumber(new Decimal('1e60'))"]),
                new Milestone(294, "A Sky Full of Stars", 120, "Get your 1000th Star", () => game.supernova.stars.gte(1000)),

                new Milestone(266, "Endgame", 1, () => "Reach " + formatNumber(new Decimal("1e1e25")) + " Scrap\nYou should take a break...", () => game.highestScrapReached.gte(new Decimal("1e1e25")),
                    ["<amount>", "formatNumber(new Decimal('1e1e25'))"]),
                new Milestone(268, "Bipolar Horseshoes", 2, () => "Reach " + formatNumber(new Decimal("1e1e25")) + " Magnets\nYou should take a break...", () => game.magnets.gte(new Decimal("1e1e25")),
                    ["<amount>", "formatNumber(new Decimal('1e1e25'))"]),
                new Milestone(269, "Enchanted Golden Apple", 4, () => "Reach " + formatNumber(new Decimal("1e1e25")) + " Golden Scrap\nOnly an apple is missing!", () => game.goldenScrap.amount.gte(new Decimal("1e1e25")),
                    ["<amount>", "formatNumber(new Decimal('1e1e25'))"]),
                new Milestone(271, "Buried Ocean", 96, () => "Reach " + formatNumber(new Decimal("1e15")) + " Plastic Bags\nNo more crabs :(", () => game.plasticBags.amount.gte(new Decimal("1e15")),
                    ["<amount>", "formatNumber(new Decimal('1e15'))"]),
                new Milestone(273, "Skyscraper to the Sun", 18, () => "Reach " + formatNumber(new Decimal("1e1e10")) + " Bricks\nAll your dreams will come true.", () => game.bricks.amount.gte(new Decimal("1e1e10")),
                    ["<amount>", "formatNumber(new Decimal('1e1e10'))"]),

                new Milestone(295, "Starstarer to the Star", 120, "Get your 3000th Star", () => game.supernova.stars.gte(3000)),
                new Milestone(221, "Duck Tales", 115, () => "Do at least 100k merges on all\nduck barrels (Progress: " + duckTales(1) + "/" + duckBarrels.length + ")\n" + duckTales(2), () => duckTales(),
                    ["<text>", "duckTales(1)"], "#6bff60"),
                new Milestone(228, "Nuclear Fusion", 65, "Do 1M manual merges\n(Merges from auto merge do not count as manual merges)\nor 100M total merges", () => game.selfMerges >= 1e6 || game.totalMerges >= 1e8,
                    [], "#6bff60"),
                new Milestone(300, "Cosmic Completion", 32, () => "Get every Cosmic Emblem Upgrade", () => Utils.filterObject(game.supernova.cosmicUpgrades, upg => upg.level > 0).length == Object.keys(game.supernova.cosmicUpgrades).length,
                    [], "#6bff60"),
        ...
        unlocked: [], // seems to be unused now
...
const unlocks = [
    ...
    new Unlock("Glitches", () => "Skill Tree (Row 3) + " + formatNumber(1e12) + " Dark Scrap", () => game.glitchesCollected > 0, { deName: "Glitche", deDesc: () => "Baum (Reihe 3) + " + formatNumber(1e12) + " Schattenschrott + Aerostahl auswählen", ruName: "Глючные", ruDesc: () => "Дерево Навыков (Ряд 3) + " + formatNumber(1e12) + " Тёмного Мусора + Аэробалки" }),
